    ...
    <div className="mx-auto flex min-h-screen w-full max-w-screen-2xl flex-col bg-white text-ink">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="relative flex flex-col rounded-[32px] border border-[#AB28B2] bg-[#AB28B2] p-8 text-white shadow-xl">
                ...
                <p className="mt-2 flex items-baseline gap-1">
                  <span className="text-4xl font-bold tracking-tight">Pay as you sell</span>
                </p>
                ...
                <p className="mt-4 text-center text-xs text-white/70">Detailed fee schedule lives in-app before you confirm a listing.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="download" className="scroll-mt-28 border-t border-line bg-surface/80 px-5 py-16 md:px-10 md:py-24">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <StoreBadgeLinks className="mt-6" />
            <a
              href={WEARHOUSE.app}
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 inline-block text-sm font-semibold text-[#AB28B2] underline-offset-2 hover:underline"
            >
              About our apps →
            </a>
            <a
              href={WEARHOUSE.privacy}
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 inline-flex rounded-full border border-black/15 bg-white px-6 py-2.5 text-sm font-semibold shadow-sm transition hover:bg-[#f6f6f6]"
            >
              Privacy policy
            </a>
          </div>
      ...
      <footer className="border-t border-line bg-white px-5 py-14 md:px-10">
        <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-[1.2fr_1fr_1fr]">
          <div>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-11 items-center justify-center rounded-2xl border border-black/10 bg-[#f6f6f6] px-4 text-sm font-semibold text-ink shadow-sm"
              >
                Website
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-11 items-center justify-center rounded-2xl border border-black/10 bg-[#fafafa] px-4 text-sm font-semibold shadow-sm"
              >
                Join
              </a>
              <a
                href="https://voltislabs.uk"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center rounded-2xl border border-black/10 bg-[#fafafa] px-4 py-2.5 text-sm font-semibold shadow-sm"
              >
                Voltis Labs
              </a>
            </div>
          ...
          <div>
            <p className="text-sm font-semibold">Legal & help</p>
            <ul className="mt-4 space-y-2 text-sm text-muted">
              <li>
        ...
        <div className="mx-auto mt-12 max-w-6xl border-t border-line pt-8">
          <div className="flex flex-col gap-2 text-sm text-muted md:flex-row md:items-center md:justify-between">
            ...
            <p className="text-xs md:text-sm">Consumer site: mywearhouse.co.uk</p>
          </div>
        </div>
      </footer>
    </div>
