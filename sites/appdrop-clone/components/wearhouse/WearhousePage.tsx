...
import { WearhouseCoverHeader } from "./WearhouseCoverHeader";
import {
  BENEFIT_PHONE,
  HERO_AVATAR,
  IMG,
          ...
          <div className="mx-auto flex max-w-[520px] flex-col items-center gap-[18px] pb-24 pt-5 text-center">
            ...
            <div className="mt-8 flex w-full justify-center px-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center rounded-full border border-black/10 bg-[#AB28B2] px-8 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#8f1f96]"
              >
                Shop all products
              </a>
            </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-8 md:grid-cols-3 md:gap-6">
              {(
                ...
                <div key={card.t} className="flex flex-col rounded-[40px] border border-black/10 bg-white shadow-sm">
                  ...
                  <div className="relative mt-auto flex w-full justify-center px-6 pb-10 pt-2 md:px-10 md:pb-12">
                    <div className="relative w-full max-w-[260px] sm:max-w-[280px]">
                      <div className="relative w-full rounded-[28px] shadow-[0_28px_56px_-18px_rgba(171,40,178,0.14),0_14px_28px_-10px_rgba(15,23,42,0.07)]">
