...
enum L10n {
    ...
    private static let greek: [String: String] = [
        ...
        "Your listing is saved as inactive and hidden from the feed until you activate it from your profile. Automatic publishing at the date you chose is not available from the server yet.": "Η αγγελία σας αποθηκεύτηκε ως ανενεργή και δεν εμφανίζεται στο feed μέχρι να την ενεργοποιήσετε από το προφίλ σας. Η αυτόματη δημοσίευση την ημερομηνία που επιλέξατε δεν υποστηρίζεται ακόμα από τον διακομιστή.",
