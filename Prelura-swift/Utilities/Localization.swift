...
enum L10n {
    ...
    private static let greek: [String: String] = [
        ...
        "Your withdrawal of %@ will be sent to your bank account within 1–3 working days.": "Η ανάληψή σας %@ θα σταλεί στον τραπεζικό σας λογαριασμό εντός 1–3 εργάσιμων ημερών.",
        "Account holder": "Δικαιούχος λογαριασμού",
        "Confirm your withdrawal": "Επιβεβαιώστε την ανάληψή σας",
        "Enter your UK bank details. Payments typically arrive within 1–3 working days.": "Εισάγετε τα στοιχεία της βρετανικής τράπεζάς σας. Οι πληρωμές συνήθως φτάνουν εντός 1–3 εργάσιμων ημερών.",
