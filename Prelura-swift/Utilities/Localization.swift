...
enum L10n {
    ...
    private static let greek: [String: String] = [
        ...
        "All": "Όλα",
        "Active": "Ενεργές",
        "No active listings": "Δεν υπάρχουν ενεργές αγγελίες",
        "Hidden": "Κρυφό",
        ...
        "5 scheduled posts": "5 προγραμματισμένες αναρτήσεις",
        "10 Lookbook products per month": "10 προϊόντα Lookbook ανά μήνα",
        "15 scheduled posts": "15 προγραμματισμένες αναρτήσεις",
        "30 Lookbook products per month": "30 προϊόντα Lookbook ανά μήνα",
        ...
        "Downgrade to Silver": "Υποβάθμιση σε Silver",
        "Gold plan": "Πλάνο Gold",
        "Your Wearhouse account is on Gold. In-app downgrades will be available when App Store billing goes live.": "Ο λογαριασμός σας στο Wearhouse είναι σε Gold. Η υποβάθμιση μέσα από την εφαρμογή θα είναι διαθέσιμη όταν ενεργοποιηθεί η χρέωση μέσω App Store.",
        ...
        "Gold is billed through Apple. Your Wearhouse profile stores a receipt summary in account settings after each successful purchase.": "Το Gold χρεώνεται μέσω Apple. Το προφίλ Wearhouse αποθηκεύει περίληψη απόδειξης μετά από κάθε επιτυχημένη αγορά.",
        "Free": "Δωρεάν",
        "£10.99/month": "£10,99/μήνα",
        "Next billing": "Επόμενη χρέωση",
        "Gold subscription isn’t available in App Store Connect for this build yet.": "Η συνδρομή Gold δεν είναι διαθέσιμη στο App Store Connect για αυτό το build ακόμα.",
        "Purchase was cancelled.": "Η αγορά ακυρώθηκε.",
        "Purchase is pending approval.": "Η αγορά εκκρεμεί έγκριση.",
        "Subscribe with App Store": "Συνδρομή μέσω App Store",
        "Enable Gold (preview - no charge)": "Ενεργοποίηση Gold (προεπισκόπηση - χωρίς χρέωση)",
        "Preview keeps Gold on this device only until App Store billing is connected.": "Η προεπισκόπηση κρατά το Gold μόνο σε αυτή τη συσκευή μέχρι να συνδεθεί η χρέωση App Store.",
